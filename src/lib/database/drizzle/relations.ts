...
import {
  ...
  productInErp,
  providerInErp,
  providerProductsInErp,
  sessionInErp,
  stockInErp,
  subCategoryInErp,
  subCategoryProductsInErp,
  teamInErp,
  userInErp,
  warehouse,
} from './schema';
...
export const organizationInErpRelations = relations(organizationInErp, ({ many }) => ({
  ...
  warehouseInErps: many(warehouse),
}));
...
export const stockInErpRelations = relations(stockInErp, ({ one }) => ({
  ...
  warehouseInErp: one(warehouse, {
    fields: [stockInErp.warehouseId],
    references: [warehouse.id],
  }),
}));

export const warehouseInErpRelations = relations(warehouse, ({ one, many }) => ({
  stockInErps: many(stockInErp),
  organizationInErp: one(organizationInErp, {
